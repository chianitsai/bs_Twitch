...
for nbr=1:1:nbr_bact
    ...
    int_pole_mean=cell(tracked_frames,1);
    contour=cell(tracked_frames,1);
    ratio_poles=zeros(tracked_frames,1);
    int_poles_max=cell(tracked_frames,1);
    ...
    for t=1:1:tracked_frames
        ...
        [int_pole_mean{t},ratio_poles(t),int_poles_max{t},int_poles_total(t)]=poles_intensity(adresse,poles{t},Bact_info,t,delta_x);
    ...
    Data_intensity{nbr,6}=int_cyto_total; 
    Data_intensity{nbr,7}=int_cyto_mean; 
