function [BactID,cell_prop,Data_intensity,Data_speed,Data_alignment,Data_projection,BactID_non_moving,cell_prop_non_moving,Data_intensity_non_moving,Data_speed_non_moving] = study_BacStalk_Fluo(adresse,speed_limit,speed_f)
...
if speed_f
    ...
    BactID_non_moving={}; cell_prop_non_moving={}; Data_intensity_non_moving={}; Data_speed_non_moving={};
end 
